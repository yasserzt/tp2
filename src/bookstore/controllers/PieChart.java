...
public class PieChart implements Initializable {
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ObservableList<javafx.scene.chart.PieChart.Data> pieChartData = FXCollections.observableArrayList(
                new javafx.scene.chart.PieChart.Data("Money Spend", 20),
                new javafx.scene.chart.PieChart.Data("Loaned Book", 12),
                new javafx.scene.chart.PieChart.Data("Most Category", 25)
        );
        pieChart.setData(pieChartData);
        pieChart.setClockwise(false);
    }

    public void build(DashCommande c) {
    }
}
